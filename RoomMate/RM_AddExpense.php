...
if(isset($_REQUEST["addproduct"])){
    ...
    $insertdetails="insert into expenses_desc(Date, Buyer_id, Buyer, Product_name, Price, 
    Description, status)values('".$Date."','".$_SESSION["LoginId"]."','".$_SESSION["Name"]."','".$Pro_Name."', '".$Pro_Price."', '".$Pro_Description."',1)";
